...
export default function SuccessModal({ isOpen, onClose, customerName, deliveryOption }: SuccessModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div className="relative bg-linear-to-br from-white to-gray-50 rounded-3xl shadow-2xl max-w-lg w-full animate-scaleIn overflow-hidden">
        ...
        <div className="p-4 text-center relative">
          ...
          <div className="mb-2 flex justify-center relative">
            ...
            <div className="relative bg-linear-to-br from-green-400 to-green-600 rounded-full p-1 shadow-lg">
          ...
          <div className={`transition-all duration-700 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <h2 className="text-lg font-bold mb-1.5 bg-linear-to-r from-blue-900 to-blue-700 bg-clip-text text-transparent">
              Order Confirmed!
            </h2>

            <div className="mb-2.5 bg-linear-to-r from-green-50 to-emerald-50 rounded-lg p-2.5 shadow-inner">
              <p className="text-base font-bold text-green-600 mb-1 animate-fadeInUp leading-tight">
                Dear {customerName} We are so grateful for your trust in our products.
              </p>
            ...
            <div className="bg-linear-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-lg p-2.5 mb-2 shadow-md">
              {deliveryOption === 'delivery' ? (
                <div className="space-y-1">
                  ...
                  <div className="bg-white/70 rounded-lg p-1.5 space-y-0.5">
                    <p className="text-xs text-gray-800 font-semibold">
                      📦 Expected delivery: <span className="text-green-700">3-5 hours</span>
                    </p>
                ...
                <div className="space-y-1">
                  ...
                  <div className="bg-white/70 rounded-lg p-1.5 space-y-0.5">
                    <p className="text-xs text-gray-800 font-semibold">
                      ⏱️ Ready in: <span className="text-green-700">2-4 hours</span>
                    </p>
                    <p className="text-xs text-gray-700">
            ...
            <div className="bg-linear-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-2 mb-3 shadow-sm">
              ...
              <div className="space-y-0.5">
                <div className="flex items-center gap-1.5 bg-white/70 rounded p-1">
                  <BsEnvelopeFill className="w-3 h-3 text-blue-600 shrink-0" />
                    <p className="text-xs text-gray-700 text-left">
                    <span className="font-semibold">Email:</span> Confirmation sent to inbox
                  </p>
                </div>
                <div className="flex items-center gap-1.5 bg-white/70 rounded p-1">
                  <BsChatDotsFill className="w-3 h-3 text-blue-600 shrink-0" />
                  <p className="text-xs text-gray-700 text-left">
            ...
            <button
              onClick={onClose}
              className="w-full text-white px-6 py-2 rounded-lg text-sm font-bold hover:scale-105 transition-all cursor-pointer shadow-lg bg-linear-to-r from-blue-900 to-blue-700 hover:from-blue-800 hover:to-blue-600"
            >
              Continue Shopping
            </button>
          </div>
